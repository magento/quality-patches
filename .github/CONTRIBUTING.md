...
3. Commits must be accompanied by meaningful commit messages. Please see the [Magento Pull Request Template](https://github.com/magento/quality-patches/blob/2.2-develop/.github/PULL_REQUEST_TEMPLATE.md) for more information.
